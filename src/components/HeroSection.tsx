    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#0d9488] to-[#134e4a]">
      ...
      <div className="absolute inset-0">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-cyan-400 rounded-full animate-particle-float opacity-60"
            style={{
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className="absolute top-1/2 right-1/3 w-48 h-48 bg-teal-400/10 rounded-full blur-3xl animate-float"
